  ...
  return (
    <div className="privacy-policy-page">
      <div className="container">
        ...
        <p>
          It is Zonily Inc.’s policy to respect your privacy regarding any
          information we may collect while operating our website. This Privacy
          Policy applies to https://zonily.com/ (hereinafter, "us", "we", or
          "https://zonily.com/"). We respect your privacy and are committed to
        ...
        <p>
          Like most website operators, Zonily Inc. collects
          non-personally-identifying information of the sort that web browsers
          and servers typically make available, such as the browser type,
          language preference, referring site, and the date and time of each
          visitor request. Zonily Inc.’s purpose in collecting non-personally
          identifying information is to better understand how Zonily Inc.’s
          visitors use its website.From time to time, Zonily Inc.may release
          non-personally-identifying information in the aggregate, e.g., by
          publishing a report on trends in the usage of its website.
        </p>
        <p>
          Zonily Inc. also collects potentially personally-identifying
          information like Internet Protocol(IP) addresses for logged in users
          and for users leaving comments on https://zonily.com/ blog posts.
          Zonily Inc. only discloses logged in user and commenter IP addresses
        ...
        <p>
          Certain visitors to Zonily Inc.’s websites choose to interact with
          Zonily Inc. in ways that require Zonily Inc. to gather
          personally-identifying information. The amount and type of information
          that Zonily Inc. gathers depends on the nature of the interaction. For
          example, we ask visitors who sign up for a blog at https://zonily.com/
        ...
        <p>
          ...
          Zonily Inc.and does not cover the use of cookies by any advertisers.
        </p>
        ...
        <h2>https://zonily.com/ uses Google AdWords for remarketing</h2>
        <p>
          https://zonily.com/ uses the remarketing services to advertise on
        ...
        <p>
          Zonily Inc. discloses potentially personally - identifying and
          personally-identifying information only to those of its employees,
          contractors and affiliated organizations that(i) need to know that
          information in order to process it on Zonily Inc.’s behalf or to
          provide services available at Zonily Inc.’s website, and(ii) that have
          ...
          your home country; by using Zonily Inc.’s website, you consent to the
          transfer of such information to them.Zonily Inc. will not rent or sell
          ...
          affiliated organizations, as described above, Zonily Inc. discloses
          potentially personally-identifying and personally-identifying
          information only in response to a subpoena, court order or other
          governmental request, or when Zonily Inc.believes in good faith that
          disclosure is reasonably necessary to protect the property or rights
          of Zonily Inc., third parties or the public at large.
        </p>
        <p>
          If you are a registered user of https://zonily.com/ and have supplied
          your email address, Zonily Inc. may occasionally send you an email to
          tell you about new features, solicit your feedback, or just keep you
          up to date with what’s going on with Zonily Inc. and our products. We
          ...
          Zonily Inc. takes all measures reasonably necessary to protect against
        ...
        <p>
          Zonily Inc.may collect statistics about the behavior of visitors to
          its website.Zonily Inc. may display this information publicly or
          provide it to others. However, Zonily Inc.does not disclose your
        ...
        <h2>Cookies</h2>
        <p>
          To enrich and perfect your online experience, Zonily Inc. uses
        ...
        <p>
          ...
          website each time the visitor returns.Zonily Inc.uses cookies to help
          Zonily Inc. identify and track visitors, their usage of
          https://zonily.com/, and their website access preferences. Zonily Inc.
          visitors who do not wish to have cookies placed on their computers
          should set their browsers to refuse cookies before using Zonily Inc.’s
          websites, with the drawback that certain features of Zonily Inc.’s
          websites may not function properly without the aid of cookies.
        </p>
        <p>
          By continuing to navigate our website without changing your cookie
          settings, you hereby acknowledge and agree to Zonily Inc.'s use of
          cookies.
        </p>

        <h2>E-commerce</h2>
        <p>
          Those who engage in transactions with Zonily Inc. by purchasing Zonily
          Inc.'s services or products, are asked to provide additional
          ...
          Zonily Inc. collects such information only insofar as is necessary or
          appropriate to fulfill the purpose of the visitor’s interaction with
          Zonily Inc.. Zonily Inc. does not disclose personally-identifying
        ...
        <p>
          If Zonily Inc., or substantially all of its assets, were acquired, or
          in the unlikely event that Zonily Inc.goes out of business or enters
          ...
          transfers may occur, and that any acquirer of Zonily Inc.may continue
          to use your personal information as set forth in this policy.
        </p>

        <h2>Privacy Policy Changes</h2>
        <p>
          Although most changes are likely to be minor, Zonily Inc.may change
          its Privacy Policy from time to time, and in Zonily Inc.’s sole
          discretion. Zonily Inc.encourages visitors to frequently check this
        ...
        <p>
          Zonily Inc.is located at: 433 Airport Boulevard, Burlingame California
          - 94010, United States.
        </p>
      </div>
    </div>
