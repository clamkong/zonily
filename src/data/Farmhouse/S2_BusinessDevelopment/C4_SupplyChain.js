      ...
      data: [
        {
          ...
          title: "Food",
          content: [
            'Food star – ones that don’t make money because the cost of making it is so high but draws customers in',
            'Money makers – ones that are fillers that customers order that the restaurant generates a profit from'
          ],
          details: [
