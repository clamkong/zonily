export default data = {
  ...
  data: [
    ...
    },
    {
      ...
      stackData: [
        {
          title: 'Snake liver farm – high standard beef',
          data: [
    ...
    },
    {
      ...
      stackData: [
        {
          title: 'Finding a good quality for a reasonable price',
          data: []
        },
        {
          title: 'Make sure you know what the culture is in the area',
          data: [
        ...
        {
          title: 'If you are a manager now, build relationships with the suppliers',
          data: [
